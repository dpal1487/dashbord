    ...
    Dropdown button
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Ryax Research</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <!-- <a href="#" class="d-block"> --><span class="text-warning">Welcome </span><span class="text-white"><b>{{Auth::user()->username}}</b></span><!-- </a> -->
                    </div>
                </div>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2021-2024 <a href="#">Ryax Research</a>.</strong>
            All rights reserved.
